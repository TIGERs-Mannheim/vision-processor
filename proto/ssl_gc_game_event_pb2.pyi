...
class GameEvent(_message.Message):
    ...
    class PlacementFailed(_message.Message):
        ...
        def __init__(self, by_team: _Optional[_Union[_ssl_gc_common_pb2.Team, str]] = ..., remaining_distance: _Optional[float] = ...) -> None: ...
